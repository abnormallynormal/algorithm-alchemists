export default function Register() {
  return (
    <div className=" pt-12 lg:pt-20 pb-4 text-white relative bg-gradient-to-b from-transparent via-purple-900/20 to-purple-900/40">
      ...
      <div className="px-16 text-lg lg:text-2xl font-bold mb-3">Contact Us!</div>
      <div className="px-16 pb-4 flex flex-row justify-between items-end text-sm lg:text-md">
