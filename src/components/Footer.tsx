export default function BetterFooter() {
  return (
      ...
      <div className="max-w-6xl mx-auto px-6 py-12 flex flex-col gap-10">
        ...
        <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-10">
          ...
          <div className="flex flex-col gap-3">
            <span className="font-h3 text-lg font-black text-white">
              Algorithm Alchemists
            </span>

            <p className="font-body-md text-sm text-slate-500 max-w-sm">
              © 2024 Algorithm Alchemists. Transform Logic into Art.
            </p>

            <div className="mt-3 flex items-center gap-2 text-xs text-slate-500">
              <span className="uppercase tracking-widest">Sponsored by</span>
        ...
        {/* Bottom Links */}
        <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-6 border-t border-white/5 pt-6">
          ...
          <p className="text-xs text-slate-600">Built with curiosity & code</p>
        </div>
      </div>
    </footer>
  );
